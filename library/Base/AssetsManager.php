...
class AssetsManager {
    ...
    public function outputJs($bKeepFilters = true)  {
        ...
        return '<script type="text/javascript" src="'.$this->getJsPathPrefix().$this->sJsOutputFileName.'"></script>';
    }
    ...
    public function outputCss($bKeepFilters = true)  {
        ...
        return '<link rel="stylesheet" href="'.$this->getCssPathPrefix().$this->sCssOutputFileName.'">';
    }
     ...
     * @return $this
     */
    public function addJsFilter($oFilter) {
     ...
     * @return $this
     */
    public function addCssFilter($oFilter) {
